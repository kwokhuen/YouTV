...
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 1, sub_category_id: 1}}
...
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 1, sub_category_id: 2}}
array.each {|data| Video.create!(data)}

# Laugh Factory
channel = Yt::Channel.new id:  'UCxyCzPY2pjAjrxoSYclpuLg'
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 1, sub_category_id: 3}}
array.each {|data| Video.create!(data)}

# SMOSH
channel = Yt::Channel.new id:  'UCY30JRSgfhYXA6i6xX1erWg'
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 1, sub_category_id: 4}}
array.each {|data| Video.create!(data)}

# Fail Army
channel = Yt::Channel.new id:  'UCPDis9pjXuqyI7RYLJ-TTSA'
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 1, sub_category_id: 5}}
array.each {|data| Video.create!(data)}

# College Humor
channel = Yt::Channel.new id:  'UCPDXXXJj9nax0fr0Wfc048g'
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 1, sub_category_id: 6}}
array.each {|data| Video.create!(data)}
...
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 2, sub_category_id: 6}}
array.each {|data| Video.create!(data)}
...
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 3, sub_category_id: 6}}
array.each {|data| Video.create!(data)}
...
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 4, sub_category_id: 9}}
array.each {|data| Video.create!(data)}
...
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 5, sub_category_id: 10}}
array.each {|data| Video.create!(data)}
...
array = []
channel.videos.take(10).each {|video| array << {youtube_id: video.id, title: video.title, description: video.description, thumbnail_url: video.thumbnail_url, embed_url: video.embed_html, category_id: 6, sub_category_id: 8}}
array.each {|data| Video.create!(data)}
